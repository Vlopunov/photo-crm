...
INSERT INTO services (name, price, duration_minutes, points_earned) VALUES
  -- Аренда залов
  ('Зал «Кристалл» — аренда', 70, 60, 20),
  ('Зал «Графит» — аренда', 70, 60, 20),
  ('Зал «Милена» — аренда', 80, 60, 25),
  -- Фотосъёмка
  ('Фотосессия с фотографом', 175, 60, 50),
  ('Семейная фотосессия', 250, 90, 80),
  ('Детская фотосессия', 200, 60, 60),
  ('Love Story', 200, 90, 70),
  -- Допуслуги
  ('Макияж и причёска', 70, 60, 15),
  -- Moloko Event
  ('Аренда зала для праздника', 100, 120, 30),
  ('Детский день рождения', 350, 180, 100),
  ('Аренда пространства для встречи', 70, 60, 20);
